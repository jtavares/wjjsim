...
public class Simultaneous2ndPriceAuctionServer {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	Vector<Simultaneous2ndPriceAuctionServerThread> myThreads = new Vector<Simultaneous2ndPriceAuctionServerThread>();
        ...
        while(!started){ //(listening && !myAuction.isOver() ){
        	...
        	Simultaneous2ndPriceAuctionServerThread aThread;
        	aThread= new Simultaneous2ndPriceAuctionServerThread( serverSocket.accept(), myAuction, numPlayersNeeded);
